  ...
  <body style="display: flex; flex-direction: column">
    <div class="int-emp int-emp-group layout54">
              ...
              <div class="int-emp-flex2 layout">
                <div class="int-emp-flex2-item">
                  <div class="int-emp-group9 layout">
                    <div
                      style="--src:url(http://localhost/PaginaWebFinal/assets/1d91f164f54fa23a599100e366665e0b.png)"
          ...
          <div class="int-emp-flex4-item1">
            <div class="int-emp-group layout">
              <div class="int-emp-flex5 layout">
                <a href="Desktop.php" style="text-decoration: none;"><div class="int-emp-txt9 layout">Luis Alberto Camarena</div></a>
                ...
                <div class="int-emp-flex8 layout">
                  <div class="int-emp-flex8-item">
                    <div class="int-emp-group31 layout">
                      <div
                        style="--src:url(http://localhost/PaginaWebFinal/assets/e3c249304af00aceeedbd44befdb0c0a.png)"
                ...
                <div class="int-emp-flex11 layout">
                  <div class="int-emp-flex11-item">
                    <div class="int-emp-group40 layout">
                      <div
                        style="--src:url(http://localhost/PaginaWebFinal/assets/8cc8ecddf859ba9f36ddea87cc10138d.png)"
      ...
      <px-posize x="561fr 66px 1101fr" y="139px 62px 916px" absolute="true"
        ><div class="int-emp-img2" style="--src:url(http://localhost/PaginaWebFinal/assets/69d690ec87262e6d91c21699ac4a6b13.png)"></div></px-posize
      ><px-posize x="559fr 69px 1100fr" y="157px 25px 935px" absolute="true"
        ><div class="int-emp-img3" style="--src:url(http://localhost/PaginaWebFinal/assets/55332f877608c9f1b3986fd0c46c1dcd.png)"></div
      ></px-posize>
