          ...
          <div class="int-emp-post-cover-block13 layout">
            <div class="int-emp-post-flex1 layout">
              <div
                ...
                class="int-emp-post-icon4 layout"
              ></div>
              ...
              <div class="int-emp-post-cover-block10 layout">
                <div
                  style="--src:url(/assets/2805d49bbf7338977dcbdb48755c9baa.png)"
                  class="int-emp-post-icon1 layout"
                ></div>
                <div
                  style="--src:url(/assets/cea2953d5f057da721482fde9542f499.png)"
                  class="int-emp-post-icon2 layout"
                ></div>
              </div>
              <div class="int-emp-post-flex5 layout">
                <div class="int-emp-post-flex5-item"><div class="int-emp-post-box10 layout"></div></div>
                <div class="int-emp-post-flex5-spacer"></div>
                <div class="int-emp-post-flex5-item"><div class="int-emp-post-box8 layout"></div></div>
                <div class="int-emp-post-flex5-spacer"></div>
                <div class="int-emp-post-flex5-item"><div class="int-emp-post-box9 layout"></div></div>
              </div>
              <div
                style="--src:url(/assets/3b3ce0d989dcd5ddee6ba7e50aa7b4c6.png)"
                class="int-emp-post-icon layout"
              ></div>
              <div
                style="--src:url(/assets/8f83a7d1f3e5bec5c47bfeba6a103133.png)"
                class="int-emp-post-cover-block11 layout"
              >
                <div
                  style="--src:url(/assets/6b2a8b41bff1a2cfdc7f576557253bb8.png)"
                  class="int-emp-post-image1 layout"
                ></div>
              </div>
            </div>
          </div>
          ...
          <div class="int-emp-post-flex6 layout">
            <div class="int-emp-post-flex7 layout">
              ...
              <div class="int-emp-post-flex7-item">
                <div
                  ...
                  class="int-emp-post-image4 layout"
                ></div>
              </div>
              ...
              <div class="int-emp-post-flex7-item1">
                <div
                  ...
                  class="int-emp-post-cover-block layout"
                >
                  <div
              ...
              <div class="int-emp-post-flex7-item2">
                <div class="int-emp-post-block1 layout">
                  <div
                    ...
                    class="int-emp-post-icon3 layout"
                  ></div>
                </div>
              </div>
              ...
              <div class="int-emp-post-flex7-item3">
                <div class="int-emp-post-block2 layout">
                  <div
                    ...
                    class="int-emp-post-image2 layout"
                  ></div>
                </div>
              </div>
              ...
              <div class="int-emp-post-flex7-item4">
                <div
                  ...
                  class="int-emp-post-icon5 layout"
                ></div>
              </div>
            </div>
            <div class="int-emp-post-flex8 layout">
              <div class="int-emp-post-flex8-item">
                <div class="int-emp-post-cover-block5 layout">
                  <a href="IntEmpCrear.html"><h5 class="int-emp-post-highlights2 layout">Borradores</h5></a>
                </div>
              </div>
              ...
              <h5 class="int-emp-post-highlights layout">Definir Zona Horaria</h5>
              <div class="int-emp-post-flex8-spacer2"></div>
              <div class="int-emp-post-flex8-item1">
                <div class="int-emp-post-content-box layout">
                  <div class="int-emp-post-text-body2 layout">GMT+06:00 Astana, UK</div>
                  <div class="int-emp-post-content-box-spacer"></div>
                  <div class="int-emp-post-content-box-item">
                    <div
                      style="--src:url(/assets/e1dd2116b0f75109122cb8810416a881.png)"
                      class="int-emp-post-image3 layout"
                    ></div>
                  </div>
                </div>
              </div>
              ...
              <div class="int-emp-post-flex9 layout">
                <div class="int-emp-post-flex9-item">
                  <div
                    ...
                    class="int-emp-post-cover-block1 layout"
                  >
                    <div
                      style="--src:url(/assets/7fdfc216ff08749a1ea825ebbae53140.png)"
                      class="int-emp-post-image7 layout"
                    ></div>
                  </div>
                </div>
                    ...
                    <div class="int-emp-post-flex12 layout">
                      ...
                      <div class="int-emp-post-flex12-item">
                        <div class="int-emp-post-cover-block3 layout">
                          <a href="IntEmp.html"><div class="int-emp-post-text-body layout">Ver aplicantes</div></a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="int-emp-post-group layout">
              ...
              <div
                ...
                class="int-emp-post-image5 layout"
              ></div>
            </div>
...
be ordered in any color combination. As it made of a moldable material (polyurethane) this background.</pre
              ...
              <div
                ...
                class="int-emp-post-image6 layout"
              ></div>
            </div>
          </div>
        </div>
