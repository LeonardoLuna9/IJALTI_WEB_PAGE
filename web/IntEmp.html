    ...
    <div class="int-emp int-emp-group layout54">
        ...
        <div class="int-emp-flex layout">
          <div class="int-emp-flex-item">
            <div class="int-emp-group4 layout">
              <div class="int-emp-group5 layout"><div class="int-emp-rect1 layout"></div></div>
            </div>
          </div>
          <div class="int-emp-flex-item1">
            <div class="int-emp-group6 layout">
              <div class="int-emp-flex1 layout">
                <div class="int-emp-group7 layout"><div class="int-emp-txt1 layout">Name</div></div>
              ...
              <div class="int-emp-flex2 layout">
                <div class="int-emp-flex2-item">
                  <div class="int-emp-group9 layout">
                    <div
                      style="--src:url(/assets/1d91f164f54fa23a599100e366665e0b.png)"
                      class="int-emp-img layout5"
                    ></div>
                  </div>
                </div>
          ...
          <div class="int-emp-flex-item4">
            <div class="int-emp-group12 layout">
              <div class="int-emp-group13 layout"><div class="int-emp-txt5 layout">GRADO DE ESTUDIOS</div></div>
            </div>
          </div>
          <div class="int-emp-flex-item5">
            <div class="int-emp-group14 layout">
              <div class="int-emp-group15 layout"><div class="int-emp-txt6 layout">PRESENTación</div></div>
            </div>
          </div>
          <div class="int-emp-flex-item6">
            <div class="int-emp-group16 layout">
              <div class="int-emp-group17 layout"><div class="int-emp-txt7 layout">Experiencia laboral</div></div>
            </div>
          </div>
          <div class="int-emp-flex-item7">
            <div class="int-emp-group18 layout">
              <div class="int-emp-group19 layout"><div class="int-emp-txt8 layout">Actions</div></div>
            </div>
          </div>
        </div>
      </div>
      <div class="int-emp-group20 layout">
        <div class="int-emp-flex4 layout">
          <div class="int-emp-flex4-item">
            <div class="int-emp-group layout"><div class="int-emp-rect2 layout"></div></div>
          </div>
          <div class="int-emp-flex4-item1">
            <div class="int-emp-group layout">
              <div class="int-emp-flex5 layout">
                <a href="Desktop.html"><div class="int-emp-txt9 layout">Luis Alberto Camarena</div></a>
          ...
          <div class="int-emp-flex4-item3">
            <div class="int-emp-group21 layout"><div class="int-emp-txt12 layout">Arquitectura de redes</div></div>
          </div>
          <div class="int-emp-txt13 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex4-item4"><div class="int-emp-group layout1"></div></div>
          <div class="int-emp-flex4-item5">
            <div class="int-emp-group layout2"><div class="int-emp-txt14 layout">Aplicar mis conocimientos</div></div>
          </div>
          <div class="int-emp-flex4-item6">
            <div class="int-emp-group layout3"><div class="int-emp-txt15 layout">Kiosko</div></div>
          </div>
          <div class="int-emp-flex4-item7">
            <div class="int-emp-group layout"><div class="int-emp-group22 layout"></div></div>
          </div>
        </div>
      ...
      <div class="int-emp-group27 layout">
        <div class="int-emp-flex6 layout">
          <div class="int-emp-flex6-item">
            <div class="int-emp-group layout">
              <div class="int-emp-group28 layout">
                <div style="--src:url(/assets/354a8efc12f43d3c44d802e1cf1eed4c.png)" class="int-emp-img layout10"></div>
              </div>
            </div>
          </div>
          ...
          <div class="int-emp-flex6-item2">
            <div class="int-emp-group layout"><div class="int-emp-txt18 layout">Electronica</div></div>
          </div>
          <div class="int-emp-flex6-item3">
            <div class="int-emp-group29 layout"><div class="int-emp-txt19 layout">Desarrollo de chips</div></div>
          </div>
          <div class="int-emp-txt20 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex6-item4"><div class="int-emp-group layout5"></div></div>
          <div class="int-emp-flex6-item5">
            <div class="int-emp-group layout6"><div class="int-emp-txt21 layout">Experiencia</div></div>
          </div>
          <div class="int-emp-flex6-item6">
            <div class="int-emp-group layout7"><div class="int-emp-txt22 layout">Bimbo</div></div>
          </div>
                ...
                <div class="int-emp-flex8 layout">
                  <div class="int-emp-flex8-item">
                    <div class="int-emp-group31 layout">
                      <div
                        style="--src:url(/assets/e3c249304af00aceeedbd44befdb0c0a.png)"
                        class="int-emp-img layout11"
                      ></div>
                    </div>
                  </div>
      ...
      <div class="int-emp-group36 layout">
        <div class="int-emp-flex9 layout">
          <div class="int-emp-flex9-item">
            <div class="int-emp-group layout">
              <div class="int-emp-group37 layout">
                <div style="--src:url(/assets/354a8efc12f43d3c44d802e1cf1eed4c.png)" class="int-emp-img layout15"></div>
              </div>
            </div>
          </div>
          ...
          <div class="int-emp-flex9-item3">
            <div class="int-emp-group38 layout"><div class="int-emp-txt27 layout">Ciberseguridad</div></div>
          </div>
          <div class="int-emp-txt28 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex9-item4"><div class="int-emp-group layout9"></div></div>
          <div class="int-emp-flex9-item5">
            <div class="int-emp-group layout10"><div class="int-emp-txt29 layout">Big Data</div></div>
          </div>
          <div class="int-emp-flex9-item6">
            <div class="int-emp-group layout11"><div class="int-emp-txt30 layout">Cibercafé de Dandy</div></div>
          </div>
                ...
                <div class="int-emp-flex11 layout">
                  <div class="int-emp-flex11-item">
                    <div class="int-emp-group40 layout">
                      <div
                        style="--src:url(/assets/8cc8ecddf859ba9f36ddea87cc10138d.png)"
                        class="int-emp-img layout16"
                      ></div>
                    </div>
                  </div>
      ...
      <div class="int-emp-group45 layout">
        <div class="int-emp-flex12 layout">
          <div class="int-emp-flex12-item">
            <div class="int-emp-group layout"><div class="int-emp-rect3 layout"></div></div>
          </div>
          ...
          <div class="int-emp-flex12-item3">
            <div class="int-emp-group46 layout"><div class="int-emp-txt35 layout">Inteligencia Artificial</div></div>
          </div>
          <div class="int-emp-txt36 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex12-item4"><div class="int-emp-group layout13"></div></div>
          <div class="int-emp-flex12-item5">
            <div class="int-emp-group layout14"><div class="int-emp-txt37 layout">Nuevos conocimientos</div></div>
          </div>
          <div class="int-emp-flex12-item6">
            <div class="int-emp-group layout15"><div class="int-emp-txt38 layout">Tuny</div></div>
          </div>
          <div class="int-emp-flex12-item7"><div class="int-emp-group layout16"></div></div>
        </div>
      ...
      <div class="int-emp-group51 layout">
        <div class="int-emp-flex14 layout">
          <div class="int-emp-flex14-item">
            <div class="int-emp-group layout"><div class="int-emp-rect4 layout"></div></div>
          </div>
          ...
          <div class="int-emp-flex14-item3">
            <div class="int-emp-group52 layout"><div class="int-emp-txt42 layout">Arquitectura de redes</div></div>
          </div>
          <div class="int-emp-txt43 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex14-item4"><div class="int-emp-group layout18"></div></div>
          <div class="int-emp-flex14-item5">
            <div class="int-emp-group layout19"><div class="int-emp-txt44 layout">Aplicar mis conocimientos</div></div>
          </div>
          <div class="int-emp-flex14-item6">
            <div class="int-emp-group layout20"><div class="int-emp-txt45 layout">Kiosko</div></div>
          </div>
          <div class="int-emp-flex14-item7">
            <div class="int-emp-group layout"><div class="int-emp-group53 layout"></div></div>
          </div>
        </div>
      ...
      <div class="int-emp-group58 layout">
        <div class="int-emp-flex16 layout">
          <div class="int-emp-flex16-item">
            <div class="int-emp-group layout">
              <div class="int-emp-group59 layout">
                <div style="--src:url(/assets/354a8efc12f43d3c44d802e1cf1eed4c.png)" class="int-emp-img layout26"></div>
              </div>
            </div>
          </div>
          ...
          <div class="int-emp-flex16-item3">
            <div class="int-emp-group60 layout"><div class="int-emp-txt49 layout">Big Data</div></div>
          </div>
          <div class="int-emp-txt50 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex16-item4"><div class="int-emp-group layout22"></div></div>
          <div class="int-emp-flex16-item5">
            <div class="int-emp-group layout23"><div class="int-emp-txt51 layout">Experiencia</div></div>
          </div>
          <div class="int-emp-flex16-item6">
            <div class="int-emp-group layout24"><div class="int-emp-txt52 layout">Space X</div></div>
          </div>
      ...
      <div class="int-emp-group67 layout">
        <div class="int-emp-flex19 layout">
          ...
          <div class="int-emp-flex19-item3">
            <div class="int-emp-group69 layout"><div class="int-emp-txt57 layout">Negocios Digitales</div></div>
          </div>
          <div class="int-emp-txt58 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex19-item4"><div class="int-emp-group layout26"></div></div>
          <div class="int-emp-flex19-item5">
            <div class="int-emp-group layout27"><div class="int-emp-txt59 layout">Blockchain y criptomonedas</div></div>
          </div>
          <div class="int-emp-flex19-item6">
            <div class="int-emp-group layout28"><div class="int-emp-txt60 layout">Oxxo</div></div>
          </div>
      ...
      <div class="int-emp-group76 layout">
        <div class="int-emp-flex22 layout">
          <div class="int-emp-flex22-item">
            <div class="int-emp-group layout"><div class="int-emp-rect5 layout"></div></div>
          </div>
          ...
          <div class="int-emp-flex22-item3">
            <div class="int-emp-group77 layout"><div class="int-emp-txt65 layout">Videojuegos</div></div>
          </div>
          <div class="int-emp-txt66 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex22-item4"><div class="int-emp-group layout30"></div></div>
          ...
          <div class="int-emp-flex22-item6">
            <div class="int-emp-group layout32"><div class="int-emp-txt68 layout">Banorte</div></div>
          </div>
          <div class="int-emp-flex22-item7"><div class="int-emp-group layout33"></div></div>
        </div>
      ...
      <div class="int-emp-group82 layout">
        <div class="int-emp-flex24 layout">
          <div class="int-emp-flex24-item">
            <div class="int-emp-group layout"><div class="int-emp-rect6 layout"></div></div>
          </div>
          ...
          <div class="int-emp-flex24-item3">
            <div class="int-emp-group83 layout"><div class="int-emp-txt72 layout">Arquitectura de redes</div></div>
          </div>
          <div class="int-emp-txt73 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex24-item4"><div class="int-emp-group layout35"></div></div>
          <div class="int-emp-flex24-item5">
            <div class="int-emp-group layout36"><div class="int-emp-txt74 layout">Nuevos retos</div></div>
          </div>
          <div class="int-emp-flex24-item6">
            <div class="int-emp-group layout37"><div class="int-emp-txt75 layout">Kiosko</div></div>
          </div>
          <div class="int-emp-flex24-item7">
            <div class="int-emp-group layout"><div class="int-emp-group84 layout"></div></div>
          </div>
        </div>
      ...
      <div class="int-emp-group89 layout">
        <div class="int-emp-flex26 layout">
          <div class="int-emp-flex26-item">
            <div class="int-emp-group layout">
              <div class="int-emp-group90 layout">
                <div style="--src:url(/assets/354a8efc12f43d3c44d802e1cf1eed4c.png)" class="int-emp-img layout42"></div>
              </div>
            </div>
          </div>
          ...
          <div class="int-emp-flex26-item3">
            <div class="int-emp-group91 layout"><div class="int-emp-txt79 layout">Desarrollo web</div></div>
          </div>
          <div class="int-emp-txt80 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex26-item4"><div class="int-emp-group layout39"></div></div>
          ...
          <div class="int-emp-flex26-item6">
            <div class="int-emp-group layout41"><div class="int-emp-txt82 layout">Cartoon Network</div></div>
          </div>
      ...
      <div class="int-emp-group98 layout">
        <div class="int-emp-flex29 layout">
          <div class="int-emp-flex29-item">
            <div class="int-emp-group layout43">
              <div class="int-emp-group99 layout">
                <div style="--src:url(/assets/354a8efc12f43d3c44d802e1cf1eed4c.png)" class="int-emp-img layout47"></div>
              </div>
            </div>
          </div>
          ...
          <div class="int-emp-flex29-item3">
            <div class="int-emp-group100 layout"><div class="int-emp-txt87 layout">Inteligencia Artificial</div></div>
          </div>
          <div class="int-emp-txt88 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex29-item4"><div class="int-emp-group layout44"></div></div>
          <div class="int-emp-flex29-item5">
            <div class="int-emp-group layout45"><div class="int-emp-txt89 layout">Aprender</div></div>
          </div>
          <div class="int-emp-flex29-item6">
            <div class="int-emp-group layout46"><div class="int-emp-txt90 layout">Google</div></div>
          </div>
      ...
      <div class="int-emp-group107 layout">
        <div class="int-emp-flex32 layout">
          <div class="int-emp-flex32-item">
            <div class="int-emp-group layout"><div class="int-emp-rect7 layout"></div></div>
          </div>
          ...
          <div class="int-emp-flex32-item3">
            <div class="int-emp-group108 layout"><div class="int-emp-txt95 layout">Ciberseguridad</div></div>
          </div>
          <div class="int-emp-txt96 layout">Doctorado en Big Data</div>
          <div class="int-emp-flex32-item4"><div class="int-emp-group layout48"></div></div>
          <div class="int-emp-flex32-item5">
            <div class="int-emp-group layout49"><div class="int-emp-txt97 layout">Aportar</div></div>
          </div>
          <div class="int-emp-flex32-item6">
            <div class="int-emp-group layout50"><div class="int-emp-txt98 layout">Tesla</div></div>
          </div>
          <div class="int-emp-flex32-item7"><div class="int-emp-group layout51"></div></div>
        </div>
      ...
      <div class="int-emp-cover-group12 layout">
        <div class="int-emp-group layout53">
          <div class="int-emp-cover-group11 layout">
            <div class="int-emp-flex34 layout">
              <div class="int-emp-flex35 layout">
                <div class="int-emp-flex35-item"><div class="int-emp-cover-block1 layout"></div></div>
                <div class="int-emp-flex35-spacer"></div>
                <div class="int-emp-flex35-item"><div class="int-emp-cover-block1 layout"></div></div>
              </div>
              <div class="int-emp-flex36 layout">
                <div class="int-emp-flex36-item"><div class="int-emp-cover-block1 layout"></div></div>
          ...
          <div class="int-emp-rect9 layout"></div>
        </div>
      </div>
      <div class="int-emp-txt99 layout">Customer Support Assistant I</div>
      <px-posize x="561fr 66px 1101fr" y="139px 62px 916px" absolute="true"
        ><div class="int-emp-img2" style="--src:url(/assets/69d690ec87262e6d91c21699ac4a6b13.png)"></div></px-posize
      ><px-posize x="559fr 69px 1100fr" y="157px 25px 935px" absolute="true"
        ><div class="int-emp-img3" style="--src:url(/assets/55332f877608c9f1b3986fd0c46c1dcd.png)"></div
      ></px-posize>
