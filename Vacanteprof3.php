...
<?php echo $row['funciones']; ?></span></pre>
    ...
    <div class="vacanteprof-group layout3">
      <div class="vacanteprof-group layout2">
        <div class="vacanteprof-group layout1"></div>
      </div>
...
Campo Profesional: <?php echo $row['campo_prof']; ?></pre>
    ...
    <form action="" method="post">
      ...
      <div class="vacanteprof-cover-block layout"><input type="submit" name="Aplicate3" value="Aplicar ahora" style="text-decoration: none; 
    ...
    <px-posize x="1664fr 48px 16fr" y="7px 46px 1064px" absolute="true" lg-x="1664fr 48px 16fr" lg-y="6px 46px 809px" md-x="1664fr 48px 16fr" md-y="5px 46px 533px" sm-x="1664fr 48px 16fr" sm-y="5px 46px 297px" xs-x="1664fr 48px 16fr" xs-y="5px 46px 179px" xxs-x="1664fr 48px 16fr" xxs-y="5px 46px 61px" tn-x="1664fr 48px 16fr" tn-y="5px 46px 5px"><a href="IntUsuProf.php" style="text-decoration: none;">
        <div class="vacanteprof-icon8" style="--src:url(/assets/c39743a94e40f92fbc033634223cd9fd.png)"></div>
      </a></px-posize>

    <px-posize x="476fr 17px 1235fr" y="52px 27px 1038px" absolute="true" lg-x="476fr 17px 1235fr" lg-y="44px 27px 790px" md-x="476fr 17px 1235fr" md-y="36px 27px 521px" sm-x="476fr 17px 1235fr" sm-y="29px 27px 290px" xs-x="476fr 17px 1235fr" xs-y="25px 27px 175px" xxs-x="476fr 17px 1235fr" xxs-y="22px 27px 60px" tn-x="476fr 17px 1235fr" tn-y="20px 27px 5px">
      <div class="vacanteprof-image14" style="--src:url(/assets/a51c9108a4402e7c5140055632e9aec0.png)"></div>
    </px-posize>
    <px-posize x="475fr 48px 1205fr" y="271px 16px 830px" absolute="true" lg-x="475fr 48px 1205fr" lg-y="212px 16px 633px" md-x="475fr 48px 1205fr" md-y="147px 16px 420px" sm-x="475fr 48px 1205fr" sm-y="92px 16px 237px" xs-x="475fr 48px 1205fr" xs-y="65px 16px 145px" xxs-x="475fr 48px 1205fr" xxs-y="37px 16px 54px" tn-x="475fr 48px 1205fr" tn-y="19px 16px 5px">
      <div class="vacanteprof-image16" style="--src:url(/assets/6114b2c347029943866dcbc63887c051.png)"></div>
    </px-posize>
  </div>
